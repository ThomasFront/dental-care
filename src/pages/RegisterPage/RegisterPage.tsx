...
export const RegisterPage = () => {
  ...
  const schema = yup.object().shape({
    ...
    name: yup.string().required('Imie jest wymagane').min(3, 'Imie musi się składać z min. 3 znaków'),
    surname: yup.string().required('Nazwisko jest wymagane').min(3, 'Nazwisko musi się składać z min. 3 znaków')
  });
